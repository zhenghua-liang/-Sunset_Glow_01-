...
from comtypes import DISPMETHOD
...
__all__ = [
    'FONTSTRIKETHROUGH', 'OLE_YSIZE_CONTAINER', 'IFontDisp',
    'OLE_XPOS_HIMETRIC', 'FONTSIZE', 'OLE_XSIZE_HIMETRIC', 'Gray',
    'IPicture', 'FontEvents', 'Unchecked', 'OLE_XSIZE_PIXELS',
    'StdPicture', 'LoadPictureConstants', 'OLE_HANDLE',
    'OLE_YPOS_PIXELS', 'IFontEventsDisp', 'OLE_YPOS_CONTAINER',
    'OLE_YSIZE_PIXELS', 'OLE_TRISTATE', 'FONTUNDERSCORE', 'StdFont',
    'OLE_CANCELBOOL', 'Font', 'IPictureDisp', 'Checked',
    'OLE_YPOS_HIMETRIC', 'FONTBOLD', 'OLE_COLOR',
    'OLE_ENABLEDEFAULTBOOL', 'FONTITALIC', 'Default',
    'OLE_XPOS_PIXELS', 'FONTNAME', 'OLE_XPOS_CONTAINER',
    'OLE_XSIZE_CONTAINER', 'VgaColor', 'OLE_YSIZE_HIMETRIC',
    'Monochrome', 'IFont', 'Color', 'Picture', 'OLE_OPTEXCLUSIVE'
]
_check_version('1.1.12', 1575709685.550032)
